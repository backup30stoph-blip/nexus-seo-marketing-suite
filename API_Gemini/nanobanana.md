...
The Nano Banana model series is Google's image generation model that creates high-quality images from text descriptions. This tutorial will show you how to use [Puter.js](https://developer.puter.com/) to access Nano Banana models ([Gemini 3.1 Flash](https://developer.puter.com/ai/google/gemini-3.1-flash-image/), [3 Pro](https://developer.puter.com/ai/google/gemini-3-pro-image/), and [2.5 Flash Image](https://developer.puter.com/ai/google/flash-image-2.5/)) for image generation, without needing a Google API key. Using Puter.js, you can access Nano Banana directly from your frontend code without any server-side setup.
